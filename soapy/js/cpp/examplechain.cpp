...
static void startStream(const v8::FunctionCallbackInfo<v8::Value>&args) {
  ...
  gain1 = new BevStream::GainStream();
  gain2 = new BevStream::GainStream();
  // gain25= new BevStream::GainStream(true, false);
  gain3 = new BevStream::GainStream();
